...
public class SZEffects {
	...
	public static final RegistryObject<MobEffect> STENCH = EFFECTS.register("stench", () -> new VicinityAffectingEffect(MobEffectCategory.BENEFICIAL, 0xCACC52, amplifier -> Math.max((amplifier + 1) * 3, 10),
